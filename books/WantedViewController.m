...
@implementation WantedViewController
...
- (void)viewDidLoad {
	...
	NSArray* result = [data objectForKey:@"want"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NewWanted *settings = [[NewWanted alloc] initWithNibName:@"NewWanted" bundle:nil];
